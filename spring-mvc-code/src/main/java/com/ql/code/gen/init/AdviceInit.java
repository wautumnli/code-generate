...
public class AdviceInit extends Init {
    ...
    Template prepare(Map<String, Object> dataMap) throws TemplateException, IOException {
        ...
        dataMap.put("file_path", dataMap.get("path") + "MyAdviceController" + GenUtil.SUFFIX);
        Configuration configuration = freeMarkerConfigurer.createConfiguration();
        return configuration.getTemplate("advice.ftl");
    }
}
